...
# players need to have attempted more then 0 shots
# fiter out those whos rate is higher than 1
# I did this because many players have recorded making shots
# but their attempts were not recorded
...
# Below are the players that did well all around.
...
# the first plot is to show the main distribution across
# the different leagues.
sns.relplot(data=players, x="year", y="threeMade", hue = "lgID")
plt.show()
# this plot helps to show a more general trend
# and the distribution with  the mean and median.
# the mean is pulled up a lot implying there are a lot of ]
# ouliers, however, most of the players are at the median.
